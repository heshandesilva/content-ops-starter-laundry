...
sections:
  - type: GenericSection
    title:
      text: Streamline Your Laundry Operations. Save Time & Resources.
      color: text-dark
      type: TitleBlock
    subtitle: Professional Laundry Solutions Tailored to Your Needs
    text: >+
      We empowers businesses with fast, reliable, and efficient commercial
      laundry services. From hotels to healthcare, we handle it all with
    ...
    actions:
      ...
      - label: Learn More
        ...
        type: Link
    media:
      url: /images/oli-woodman-NH_WYPn-4Vc-unsplash.jpg
      altText: Unblock your team boost your time to production preview
      elementId: ''
      type: ImageBlock
    badge:
      label: THIS IS OUR PROMISE
      color: text-primary
      type: Badge
    elementId: ''
    ...
    items:
      ...
      - title: 20x
        ...
        text: >
          ...
          Our advanced processes make your laundry turnaround 20 times faster,
          saving your business valuable time.
        image:
  ...
  - title:
      ...
      styles:
        self:
          textAlign: center
      type: TitleBlock
    subtitle: Faster Turnarounds. Higher Efficiency. Better Results.
    text: >
      Experience 10x faster service and seamless operations with our reliable
      and professional laundry solutions. Let us handle your laundry needs so
